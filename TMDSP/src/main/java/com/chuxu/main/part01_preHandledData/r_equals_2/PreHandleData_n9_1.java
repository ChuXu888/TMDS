...
public class PreHandleData_n9_1 {
    ...
    public static int[][] neighborMatrix = {
            {0, 1, INF, INF, INF, 1, 1, 1, INF},
            {1, 0, 1, INF, 1, INF, INF, INF, INF},
            {INF, 1, 0, 1, INF, INF, INF, INF, 1},
            {INF, INF, 1, 0, INF, INF, 1, INF, 1},
            {INF, 1, INF, INF, 0, 1, 1, 1, INF},
            {1, INF, INF, INF, 1, 0, INF, INF, 1},
            {1, INF, INF, 1, 1, INF, 0, INF, INF},
            {1, INF, INF, INF, 1, INF, INF, 0, INF},
            {INF, INF, 1, 1, INF, 1, INF, INF, 0},
    };
