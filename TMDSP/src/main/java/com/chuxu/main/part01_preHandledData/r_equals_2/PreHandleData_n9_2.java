...
public class PreHandleData_n9_2 {

    public static int INF = 10000;  //代表不连通
    public static final int r = 2;  //阈值
    public static int n = 9;  //问题规模
    public static int[][] neighborMatrix = {
            {0, INF, 1, INF, 1, 1, 1, INF, INF},
            {INF, 0, INF, INF, 1, 1, INF, 1, 1},
            {1, INF, 0, 1, INF, 1, INF, 1, INF},
            {INF, INF, 1, 0, 1, INF, INF, 1, 1},
            {1, 1, INF, 1, 0, INF, INF, 1, INF},
            {1, 1, 1, INF, INF, 0, 1, INF, INF},
            {1, INF, INF, INF, INF, 1, 0, INF, INF},
            {INF, 1, 1, 1, 1, INF, INF, 0, 1},
            {INF, 1, INF, 1, INF, INF, INF, 1, 0},
    };
    ...
    public static void preHandle() {
        ...
        for (int i = 0; i < nodeCounts; i++) {
            ...
            int[] curNeighborVector = PreHandleData_n9_2.neighborMatrix[i];
