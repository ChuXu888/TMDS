...
import com.chuxu.main.part01_preHandledData.r_equals_3.PreHandleData_n50_2;
...
public class MainAlgorithm {
    public static final int[][] neighborMatrix = PreHandleData_n50_2.neighborMatrix;  //邻接矩阵
    public static final int r = PreHandleData_n50_2.r;  //阈值
    ...
    public static int countOfProperty04 = 0;  //二叉树搜索中性质4使用次数
...
//        S_best.forEach(System.out::println);
    ...
    public static void deepCopy() {
        LinkedHashSet<Node> nodes = PreHandleData_n50_2.nodes;
        for (Node node : nodes) {
            V.add(node.clone());
