...
//        //若性质2返回false，则无可行解，右子树剪枝
//        if (Properties.property02(W, V, V1, VV1)) {//若性质2返回true则继续判断}
...
//                return;
            ...
            if (b > u) {
                ...
                LinkedHashSet<Integer> nodeIdsOfProperty04 = Properties.property03(W, V, V1, VV1);
                //如果性质4满足，那就有一套相应的操作。
...
//            W.forEach(System.out::println);
            ...
            if (Sc_2.size() != 0) {
                ...
                LinkedHashSet<Node> Sc_Add_V1_Add_VV1 = new LinkedHashSet<>(Sc_2);
                Sc_Add_V1_Add_VV1.addAll(V1);
                Sc_Add_V1_Add_VV1.addAll(VV1);
//                System.out.println("满足性质10的条件，Sc_2∪V1∪VV1即为一个可行解！");
//                Sc_Add_V1_Add_VV1.forEach(System.out::println);
                int z = Sc_Add_V1_Add_VV1.size();
                if (z < u) {
                    u = z;
